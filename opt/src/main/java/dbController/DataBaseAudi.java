...
public class DataBaseAudi {
    ...
    // заполнение TableViw +++++
    public static ObservableList<DataBaseOutput> initTableView() throws SQLException, ClassNotFoundException {
        connect();
    ...
    public static void loadAllPrice(String loadFileAllPrice) throws Exception {
        connect();
    ...
    public static void loadPartsCS(String loadFileStockCS) throws Exception {
        connect();
    ...
    public static void formPriceStockCS(String discount) throws SQLException, ClassNotFoundException {
        connect();
        try {
    ...
    public static void formPriceZSOCS(String discount) throws SQLException, ClassNotFoundException {
        connect();
        try {
            statement.execute("TRUNCATE TABLE price_stock_cs;");
            statement.execute("INSERT INTO price_stock_cs " +
    ...
    public static void formPriceStockGroups(String discount12, String discount8, String discount4, String discount2) throws SQLException, ClassNotFoundException {
        connect();
        try {
            statement.execute("TRUNCATE TABLE price_stock_cs;");
            statement.execute("INSERT INTO price_stock_cs " +
    ...
    public static void formPriceZSOGroups(String discount12, String discount8, String discount4, String discount2) throws SQLException, ClassNotFoundException {
        connect();
        try {
            statement.execute("TRUNCATE TABLE price_stock_cs;");
            statement.execute("INSERT INTO price_stock_cs " +
